...
const u16 gHoennToNationalOrder[] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(CROOKODILE),
    HOENN_TO_NATIONAL(SCRAFFY),
...
static const u8 sMonFrontAnimIdsTable[] =
{
    ...
    [SPECIES_FLETCHINDER - 1] = 0x00,
    [SPECIES_TOGEKISS - 1] = 0x00,
    [SPECIES_FLORGES - 1] = 0x00,
    [SPECIES_KLEFKI - 1] = 0x00,
    [SPECIES_MIMIKYU - 1] = 0x00,
    [SPECIES_FALINKS - 1] = 0x00,
    [SPECIES_MONFERNO - 1] = 0x00,
    [SPECIES_GALLADE - 1] = 0x00,
    [SPECIES_MALAMAR - 1] = 0x00,
    [SPECIES_ORBEETLE - 1] = 0x00,
    [SPECIES_SIGILYPH - 1] = 0x00,
    [SPECIES_MAMOSWINE - 1] = 0x00,
    [SPECIES_PALISAND - 1] = 0x00,
    [SPECIES_DIGGERSBY - 1] = 0x00,
    [SPECIES_AEGISLASH - 1] = 0x00,
    [SPECIES_MAGNEZONE - 1] = 0x00,
    [SPECIES_EMPOLEON - 1] = 0x00,
    [SPECIES_MUK_ALOLAN - 1] = 0x00,
    [SPECIES_DRAPION - 1] = 0x00,
    [SPECIES_CROOKODILE - 1] = 0x00,
    [SPECIES_SCRAFFY - 1] = 0x00,
    [SPECIES_GRIMSNARL - 1] = 0x00,
