...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_KLEFKI] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MIMIKYU] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_FALINKS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MONFERNO] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_GALLADE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MALAMAR] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_ORBEETLE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SIGILYPH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MAMOSWINE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_PALISAND] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_DIGGERSBY] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_AEGISLASH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MAGNEZONE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_EMPOLEON] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_MUK_ALOLAN] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_DRAPION] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_CROOKODILE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_SCRAFFY] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_GRIMMSNARL] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
