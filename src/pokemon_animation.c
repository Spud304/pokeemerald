...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    //TODO: Figure out proper animation for each one
    [SPECIES_GRENINJA] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_FLETCHINDER] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_TOGEKISS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_KLEFKI] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_MIMIKYU] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_FALINKS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_MONFERNO] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_GALLADE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_MALAMAR] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_ORBEETLE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_SIGILYPH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_MAMOSWINE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_PALISAND] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_DIGGERSBY] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_AEGISLASH] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_MAGNEZONE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_EMPOLEON] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_MUK_ALOLAN] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_DRAPION] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_CROOKODILE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_SCRAFFY] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPEICES_GRIMMSNARL] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
